...
export const KyiIcCalculatorMaster = () => {
  ...
  const handleEdit = (row: KyiIcCalculator) => {
    ...
    setFormData({
      ...
      policy_id:
        (row as any).policy_id ??
        (row as any).policy?.id ??
        undefined,

      msme_year_value:
        (row as any).msme_year_value ??
        (row as any).msmeYear?.id ??
        undefined,
      ...
      unit_type_value:
        (row as any).unit_type_value ??
        (row as any).unitType?.id ??
        undefined,

      sector_value:
        (row as any).sector_value ??
        (row as any).sector?.id ??
        undefined,
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-4 mb-3">
              ...
              <Dropdown
                ...
                optionValue="id"
                onChange={(e) =>
                  handleFormChange("sub_sector_value", e.value)
                }
            ...
            <div className="col-12 col-md-4 mb-3">
              ...
              <Dropdown
                ...
                optionValue="id"
                onChange={(e) =>
                  handleFormChange("unit_type_value", e.value)
                }
            ...
            <div className="col-12 col-md-4 mb-3">
              <label className="form-label fw-bold">MSME Year</label>
              <Dropdown
            ...
            <div className="col-12 col-md-4 mb-3">
              ...
              <Dropdown
                ...
                optionValue="id"
                onChange={(e) =>
                  handleFormChange("ocurrance_value", e.value)
                }
            ...
            <div className="col-12 col-md-4 mb-3">
              ...
              <Dropdown
                ...
                optionValue="id"
                onChange={(e) =>
                  handleFormChange("incentive_value", e.value)
                }
            ...
            <div className="col-12 col-md-4 mb-3">
              ...
              <InputTextarea
                ...
                onChange={(e) =>
                  handleFormChange("limitation", e.target.value)
                }
                rows={1}
                autoResize
              />
