...
import {
    useJDInspectionChecklist,
    useJDUpdateInspectionChecklist,
...
// Main Component
// ===================================
export default function JDChecklistDetailPage({ params }: { params: Promise<{ id: string }> }) {
    const resolvedParams = use(params);
    const checklistId = parseInt(resolvedParams.id);
    const { data: checklist, isLoading, error } = useJDInspectionChecklist(checklistId);
    const updateChecklist = useJDUpdateInspectionChecklist();
        ...
        return (
            <div className="container-fluid p-4" style={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>
                <div className="alert alert-danger">
                    ...
                    Failed to load checklist. Please try again or ensure you have access.
                </div>
                <Link href="/investor/inspections/jd-portal/checklists" className="btn btn-outline-primary mt-3">
                    Back to Checklists
                </Link>
            </div>
        );
            ...
            <nav aria-label="breadcrumb" className="mb-4">
                <ol className="breadcrumb mb-0">
                    <li className="breadcrumb-item">
                        <Link href="/investor/inspections/jd-portal/checklists" className="text-decoration-none text-primary">
