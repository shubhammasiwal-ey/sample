            ...
            <div className="row g-3 mb-4">
                <div className="col-md-3">
                    <div className="card border-0 shadow-sm h-100 border-start border-4 border-primary">
                        <div className="card-body">
                            <h6 className="text-uppercase text-muted small fw-bold mb-2">Total Inspections</h6>
                            <div className="d-flex align-items-center justify-content-between">
                                <h2 className="mb-0 fw-bold text-primary">{stats.total}</h2>
                ...
                <div className="col-md-3">
                    <div className="card border-0 shadow-sm h-100 border-start border-4 border-warning">
                        <div className="card-body">
                            <h6 className="text-uppercase text-muted small fw-bold mb-2">Pending Inspections</h6>
                            <div className="d-flex align-items-center justify-content-between">
                                <h2 className="mb-0 fw-bold text-warning">{stats.scheduled}</h2>
                                                ...
                                                <div className="d-flex justify-content-end gap-2">
                                                    {statusFilter === 'completed' ? (
                                                        ...
                                                        <>
                                                            ...
                                                            <Link href={`/department/inspection/${item.id}/conduct`} className="btn btn-sm btn-primary">
