        ...
        steps: [
            ...
            // ========== Step 2: Project Details ==========
            {
                ...
                sections: [
                    ...
                    // Proposed Machinery/Equipment Details Section (Add More Example)
                    {
                        id: 'machinery-details',
                        title: 'Proposed Machinery & Equipment',
                        description: 'Add details of all machinery/equipment to be installed',
                        columns: 1,
                        collapsible: true,
                        fields: [
                            {
                                ...
                                type: 'addmore',
                                colSpan: 1,
                                helpText: 'Add all proposed machinery and equipment with estimated costs',
                                addMoreConfig: {
                                    columns: [
                                        {
                                            name: 'equipmentName',
                                            label: 'Equipment/Machinery Name',
                                            type: 'text',
                                    ...
                                    defaultRow: { quantity: 1, unitCost: 0, isImported: 'no' }
                                }
                            }
                        ]
                    }
